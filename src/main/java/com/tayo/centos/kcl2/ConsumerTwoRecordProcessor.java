 ...
 */
public class ConsumerTwoRecordProcessor implements IRecordProcessor
{
    private static final Logger log = LoggerFactory.getLogger(ConsumerTwoRecordProcessor.class);
